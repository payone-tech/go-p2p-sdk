...
func main() {
	...
	params := proto.CancelWithdrawRequest{
		ClientTxID: &clientTxID,
	}

	b, _ := json.Marshal(params)
	request := proto.RpcRequest{
		Method: api.MethodOrderWithdrawCancel,
		Params: b,
	}
