...
func main() {
	...
	k := []string{"client_tx_id", "sum", "currency_uuid"}
	...
	params := proto.CreateDepositRequest{
	...
	request := proto.RpcRequest{
		Method: api.MethodOrderDepositCreate,
		Params: b,
	}
	...
	var protoResponse *proto.CreateDepositResponse
